...
export const ACTION_CREATE_NEW_INFO = 'action/ACTION_CREATE_NEW_INFO';

export const ACTION_GET_AGREEMENT = 'action/ACTION_GET_AGREEMENT';

export const ACTION_CLOASE_ACTIVE = 'action/ACTION_CLOASE_ACTIVE';