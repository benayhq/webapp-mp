...
function temporarilyNotSupport(apiName) {
  return function () {
    return console.error("\u6682\u65F6\u4E0D\u652F\u6301 API ".concat(apiName));
  };
}

function permanentlyNotSupport(apiName) {
  return function () {
    return console.error("\u4E0D\u652F\u6301 API ".concat(apiName));
  };
}
...
var createInnerAudioContext = temporarilyNotSupport('createInnerAudioContext');
...
var pageScrollTo = temporarilyNotSupport('pageScrollTo'); // export const createSelectorQuery = temporarilyNotSupport('createSelectorQuery')
...
var stopPullDownRefresh = temporarilyNotSupport('stopPullDownRefresh');
...
var uploadFile = temporarilyNotSupport('uploadFile');
var downloadFile = temporarilyNotSupport('downloadFile'); // export const connectSocket = temporarilyNotSupport('connectSocket')
...
var reLaunch = temporarilyNotSupport('reLaunch'); // 位置

var getLocation = temporarilyNotSupport('getLocation');
...
var scanCode = temporarilyNotSupport('scanCode');
var setClipboardData = temporarilyNotSupport('setClipboardData');
var getClipboardData = temporarilyNotSupport('getClipboardData');
...
var setNavigationBarColor = temporarilyNotSupport('setNavigationBarColor'); // export const setTabBarBadge = temporarilyNotSupport('setTabBarBadge')
...
var startPullDownRefresh = temporarilyNotSupport('startPullDownRefresh');
...
var _set$app = function _set$app(app) {
  taro._$app = app;
};
...
var _set$router = function _set$router(router) {
