(function (global, factory) {
  ...
  function filterProps() {
    ...
    var weappComponentData = arguments.length > 2 ? arguments[2] : undefined;
    var properties = weappComponentData || {};
  ...
  function initComponent(ComponentClass, isPage) {
    ...
    if (hasPageInited && !isPage) {
      var nextProps = filterProps(ComponentClass.defaultProps, this.$component.props, this.props);
  ...
  */
  ...
  function doUpdate(component, prevProps, prevState) {
    ...
    data[privatePropKeyName] = !privatePropKeyVal; // 每次 setData 都独立生成一个 callback 数组
