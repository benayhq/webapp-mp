...
var ChangeUser = (_temp2 = _class = function (_BaseComponent) {
  ...
  function ChangeUser() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ChangeUser.__proto__ || Object.getPrototypeOf(ChangeUser)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["isAgent", "showUserText"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return ChangeUser;
}(_index.Component), _class.properties = {}, _class.$$events = ["handleChangeState"], _temp2);
