...
var UserOrder = (_temp2 = _class = function (_BaseComponent) {
  ...
  function UserOrder() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UserOrder.__proto__ || Object.getPrototypeOf(UserOrder)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray11", "list", "undefined", "isAgent"], _this.customComponents = ["AtBadge"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(UserOrder, [{
    ...
    value: function _createData() {
      ...
      var loopArray11 = list && list != undefined ? list.map(function (item, index) {
        ...
        var _genCompid = (0, _index.genCompid)(__prefix + "fzzzzzzzzz" + index, true),
