...
var ActiveItem = (_temp2 = _class = function (_BaseComponent) {
  ...
  function ActiveItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ActiveItem.__proto__ || Object.getPrototypeOf(ActiveItem)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "item", "actives", "handleCloseActive"], _this.state = {
      actives: []
  ...
  _createClass(ActiveItem, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = item ? (0, _index.internal_inline_style)(item.status === "NORMAL" ? 'color:#7DD6D0' : 'color:#919191') : null;
  ...
  return ActiveItem;
}(_index.Component), _class.$$events = ["HandleActiveClick", "HandleCloseActive"], _class.$$componentPath = "pages/user/component/activeItem/index", _temp2);
