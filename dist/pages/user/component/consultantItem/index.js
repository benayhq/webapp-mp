...
var Item = function (_BaseComponent) {
  ...
  function Item() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Item.__proto__ || Object.getPrototypeOf(Item)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["active", "actives"], _this.state = {
      actives: []
...
Item.$$events = ["handleListItem", "handleMakeCall"];
