...
var Index = (_dec = (0, _index3.connect)(function (state) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray6", "customer", "dispatchCustomerList"], _this.config = {
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      if (customer.length === 0) {} else {
        loopArray6 = customer ? customer.map(function (item, _anonIdx) {
          item = {
