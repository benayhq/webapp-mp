...
var Index = (_dec = (0, _index3.connect)(function (state) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray315", "customer", "dispatchCustomerList"], _this.config = {
    ...
    value: function _createData() {
      ...
      if (customer.length === 0) {} else {
        loopArray315 = customer ? customer.map(function (item, _anonIdx) {
          ...
          var $compid__1150 = (0, _index.genCompid)(__prefix + "STlaLbztyF" + _anonIdx);
          ...
          return {
            ...
            $compid__1150: $compid__1150,
            $original: item.$original
          };
        }) : [];
      }
      Object.assign(this.__state, {
        loopArray315: loopArray315
      });
      return this.__state;
    }
  }]);
