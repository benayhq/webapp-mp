...
var _order = require("../common/order.js");
...
var OrderDetail = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OrderDetail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderDetail.__proto__ || Object.getPrototypeOf(OrderDetail)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["order", "content"], _this.config = {
  ...
  _createClass(OrderDetail, [{
    ...
    value: function componentDidMount() {
      ...
      var message = order.getStatuInfo({ status: this.$router.params.status });
      this.setState({
        content: message
      });
