...
var OrderItem = (_temp2 = _class = function (_BaseComponent) {
  ...
  function OrderItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderItem.__proto__ || Object.getPrototypeOf(OrderItem)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["OrderState", "list"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
