...
var Comment = (_dec = (0, _index3.connect)(function (state) {
  ...
  function Comment() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Comment.__proto__ || Object.getPrototypeOf(Comment)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__53", "$compid__54", "$compid__55", "$compid__56", "$compid__57", "$compid__58", "$compid__59", "commentValue", "envValue", "serveValue", "profValue", "effectValue", "files", "location", "dispatchUploadConfig", "dispatchCreateOrderDownLoadUrl", "dispatchCreateComment"], _this.config = {
