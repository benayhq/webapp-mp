...
var Comment = (_dec = (0, _index3.connect)(function (state) {
  ...
  function Comment() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Comment.__proto__ || Object.getPrototypeOf(Comment)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__49", "$compid__50", "$compid__51", "$compid__52", "$compid__53", "$compid__54", "$compid__55", "commentValue", "envValue", "serveValue", "profValue", "effectValue", "files", "location", "dispatchUploadConfig", "dispatchCreateOrderDownLoadUrl", "dispatchCreateComment"], _this.config = {
