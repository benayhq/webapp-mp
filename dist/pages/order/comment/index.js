...
var Comment = (_dec = (0, _index3.connect)(function (state) {
  ...
  function Comment() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Comment.__proto__ || Object.getPrototypeOf(Comment)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["envValue", "serveValue", "profValue", "effectValue", "commentValue", "files", "location", "dispatchUploadConfig", "dispatchCreateOrderDownLoadUrl", "dispatchCreateComment"], _this.config = {
  ...
  return Comment;
}(_index2.default.Component), _class2.properties = {
...
}, _class2.$$events = ["handleEnvChange", "handleServeChange", "handleProfChange", "handleEffectChange", "handleChange", "onFail", "onImageClick", "onChange", "handleComment"], _temp2)) || _class);
