...
var Footer = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Footer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Footer.__proto__ || Object.getPrototypeOf(Footer)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__67", "$compid__68", "qrCode", "content"], _this.customComponents = ["Code", "Info"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Footer, [{
    ...
    value: function _createData() {
      ...
      this.__props.qrCode && _index.propsManager.set($props__67, $compid__67);
      _index.propsManager.set($props__68, $compid__68);
