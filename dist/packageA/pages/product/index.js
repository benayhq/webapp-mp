...
var Index = (_dec = (0, _index3.connect)(function (state) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__50", "checkedList", "productList", "newFilterList", "productIds", "dispatchDownLoadUrl", "dispatchProductList", "dispatchDeleteProduct"], _this.config = {
  ...
  _createClass(Index, [{
    ...
    value: function componentWillMount() {
      var productIds = this.$router.params.productIds;
    ...
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var that, payload, responseList, productIds, historys, promises, response;
              ...
              case 8:
                ...
                if (response.content) {
                  response.content.map(function (item, index) {
                    var promise = that.getImgUrl(item.location);
                    promises.push(promise);
                    historys.push(item);
                  });
                }
                Promise.all(promises).then(function (imageResponse) {
                  console.log('imageResponse', imageResponse);
                  historys.map(function (item, key) {
                    responseList.push({
                      value: item.id,
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _index.genCompid)(__prefix + "$compid__50"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__50 = _genCompid2[0],
          $compid__50 = _genCompid2[1];

      var _state = this.__state,
          newFilterList = _state.newFilterList,
          productIds = _state.productIds;


      var anonymousState__temp = (0, _index.internal_inline_style)({ height: this.getWindowHeight(true), 'margin-bottom': '190px' });
  ...
  return Index;
}(_index.Component), _class2.$$events = ["handleSaveItem"], _class2.$$componentPath = "packageA/pages/product/index", _temp2)) || _class);
