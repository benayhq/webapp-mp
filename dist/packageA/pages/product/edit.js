...
var EditProduct = (_dec = (0, _index3.connect)(function (state) {
  ...
  _createClass(EditProduct, [{
    ...
    value: function _constructor() {
      _get(EditProduct.prototype.__proto__ || Object.getPrototypeOf(EditProduct.prototype), "_constructor", this).call(this);
      this.state = {
        files: [],
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _index.genCompid)(__prefix + "$compid__51"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__51 = _genCompid2[0],
          $compid__51 = _genCompid2[1];

      var _genCompid3 = (0, _index.genCompid)(__prefix + "$compid__52"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__52 = _genCompid4[0],
          $compid__52 = _genCompid4[1];

      var _genCompid5 = (0, _index.genCompid)(__prefix + "$compid__53"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__53 = _genCompid6[0],
          $compid__53 = _genCompid6[1];

      var _genCompid7 = (0, _index.genCompid)(__prefix + "$compid__54"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__54 = _genCompid8[0],
          $compid__54 = _genCompid8[1];

      var _genCompid9 = (0, _index.genCompid)(__prefix + "$compid__55"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__55 = _genCompid10[0],
          $compid__55 = _genCompid10[1];

      var _genCompid11 = (0, _index.genCompid)(__prefix + "$compid__56"),
  ...
  return EditProduct;
}(_index.Component), _class2.$$events = ["handleColumnChange", "handleMulitChange", "handleSaveProduct"], _class2.$$componentPath = "packageA/pages/product/edit", _temp2)) || _class);
