...
var CreateProduct = (_dec = (0, _index3.connect)(function (state) {
  ...
  _createClass(CreateProduct, [{
    ...
    value: function _constructor() {
      _get(CreateProduct.prototype.__proto__ || Object.getPrototypeOf(CreateProduct.prototype), "_constructor", this).call(this);
      this.state = {
        productList: []
      };
...
}(_index.Component), _class2.$$events = ["handleEditProduct"], _class2.$$componentPath = "packageA/pages/product/add", _temp2)) || _class);
