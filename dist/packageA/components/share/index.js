...
var Share = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Share() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Share.__proto__ || Object.getPrototypeOf(Share)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__83", "activeId", "isOpened"], _this.customComponents = ["AtFloatLayout"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Share, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _index.genCompid)(__prefix + "$compid__83"),
  ...
  return Share;
}(_index.Component), _class.$$events = ["handleCreatePosters"], _class.$$componentPath = "packageA/components/share/index", _temp2);
