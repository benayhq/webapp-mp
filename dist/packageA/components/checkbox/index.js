...
var CheckBox = (_temp2 = _class = function (_BaseComponent) {
  ...
  function CheckBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CheckBox.__proto__ || Object.getPrototypeOf(CheckBox)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray18", "rootCls", "options", "selectedList", "className", "customStyle"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(CheckBox, [{
    ...
    value: function handleClick(idx) {
      ...
      if (selectedList != null && selectedList != "") {
        if (selectedList.constructor === Array) {
    ...
    value: function _createData() {
      ...
      var loopArray18 = options ? options.map(function (option, idx) {
        option = {
  ...
  return CheckBox;
}(_index.Component), _class.$$events = ["handleClick", "handleProductEdit", "handleProductDelete"], _class.$$componentPath = "packageA/components/checkbox/index", _temp2);
