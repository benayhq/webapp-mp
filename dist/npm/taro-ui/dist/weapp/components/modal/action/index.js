...
var AtModalAction = function (_AtComponent) {
  ...
  function AtModalAction() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtModalAction.__proto__ || Object.getPrototypeOf(AtModalAction)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["rootClass", "children"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
AtModalAction.properties = {
  "isSimple": null,
  "className": null
};
AtModalAction.$$events = [];
