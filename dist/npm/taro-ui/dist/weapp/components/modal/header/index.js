...
var AtModalHeader = function (_AtComponent) {
  ...
  function AtModalHeader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtModalHeader.__proto__ || Object.getPrototypeOf(AtModalHeader)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["rootClass", "children"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
AtModalHeader.properties = {
  "className": null
};
AtModalHeader.$$events = [];
