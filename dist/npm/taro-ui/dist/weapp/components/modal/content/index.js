...
var AtModalContent = function (_AtComponent) {
  ...
  function AtModalContent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtModalContent.__proto__ || Object.getPrototypeOf(AtModalContent)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["rootClass", "children"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
AtModalContent.properties = {
  "className": null
};
AtModalContent.$$events = [];
