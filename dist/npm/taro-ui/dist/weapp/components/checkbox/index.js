...
var AtCheckbox = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtCheckbox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtCheckbox.__proto__ || Object.getPrototypeOf(AtCheckbox)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray0", "rootCls", "options", "selectedList", "__fn_onChange", "customStyle", "className"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtCheckbox, [{
    ...
    value: function handleClick(idx) {
      ...
      this.__triggerPropsFn("onChange", [null].concat([[].concat(_toConsumableArray(selectedSet))]));
    }
  }, {
    key: "_createData",
