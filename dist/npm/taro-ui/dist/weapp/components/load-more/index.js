...
var AtLoadMore = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtLoadMore() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtLoadMore.__proto__ || Object.getPrototypeOf(AtLoadMore)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["_$anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "$compid__81", "$compid__82", "status", "moreText", "noMoreText", "className", "customStyle", "loadingText", "moreBtnStyle", "noMoreTextStyle"], _this.customComponents = ["AtActivityIndicator", "AtButton"], _temp), _possibleConstructorReturn(_this, _ret);
  }
