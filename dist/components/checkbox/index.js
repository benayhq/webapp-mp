...
var CheckBox = (_temp2 = _class = function (_BaseComponent) {
  ...
  function CheckBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CheckBox.__proto__ || Object.getPrototypeOf(CheckBox)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray14", "rootCls", "options", "selectedList", "className", "customStyle"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(CheckBox, [{
    ...
    value: function _createData() {
      ...
      var loopArray14 = options ? options.map(function (option, idx) {
        option = {
